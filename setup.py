...
setup(
    ...
    install_requires=["elasticsearch>=6.8.0, <7", "packaging>=21.0, <22.0", "sqlalchemy"],
    extras_require={"opendistro": ["requests_aws4auth", "boto3"]},
    author="Preset Inc.",
    author_email="daniel@preset.io",
    url="http://preset.io",
    download_url="https://github.com/snps-punjabi/elasticsearch6-dbapi/releases/tag/v0.1",
    classifiers=[
